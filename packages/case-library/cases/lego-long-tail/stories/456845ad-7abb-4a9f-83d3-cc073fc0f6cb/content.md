# From near-bankruptcy to two long tails: LEGO 2003-2025

In 2003 LEGO posted the worst financial results in its 70-year history — a DKK 1 billion loss on falling sales. The company was, by its own management's later admission, on the verge of bankruptcy. The cause wasn't lack of brand affection; AFOLs (adult fans of LEGO) were as devoted as ever. The cause was the toy industry's bestseller logic finally hitting LEGO's specific economic model: a hits-driven retail model demanded a flow of new themes; new themes demanded new molds; new molds demanded production runs that needed to clear retail shelves before the next theme arrived. The math collapsed when too many themes missed the bestseller threshold.
...
## First long tail: LEGO Factory (2005-2014)

Under Jørgen Vig Knudstorp's leadership, LEGO went looking for ways to *use the existing brick library to serve niche audiences without commissioning new molds*. The first answer was LEGO Factory (later renamed Design byME), launched in 2005.
...
## Second long tail: LEGO Ideas (CUUSOO 2008 → Lego Ideas 2014)
...
As of 2025, Lego Ideas has produced 60+ commercial sets sourced from community submissions — from a NASA Apollo Saturn V to a recreation of Doctor Who's TARDIS. Those sets sit on the same retail shelves as Star Wars and Harry Potter — but the niche-aggregated tail is what funded their existence in the first place.

## Why one survived and the other didn't

The textbook lesson is sometimes told as "Factory failed, Ideas succeeded" — but that's the wrong frame. Factory tested whether LEGO could make *production* itself a long tail (one custom set at a time). The economics weren't there in 2005-2014; physical brick picking has never reached zero marginal cost. Ideas tested whether LEGO could make *selection* a long tail (a community votes which niche designs deserve a real production run). That worked, and continues to work, because aggregation + curation is exactly the long-tail mechanism Anderson described — Factory was actually closer to a *mass customization* play than a long tail one. Both moves were necessary experiments; only one matched the pattern's signals.