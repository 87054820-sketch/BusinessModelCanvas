...
Use it when the team has a customer segment but the value proposition sounds vague: “convenient,” “premium,” “simple,” or “delightful.” The framework helps specify what customers value and which elements should be raised, combined, or proved.

Do not use it to claim every possible value element. A strong proposition usually wins by selecting a few elements that matter deeply to a segment.
...
- `nespresso` combines quality, sensory appeal, reduced effort, badge value, and recurring access.
- `drybar` narrows the service around experience, reduced effort, and confidence.
- `stitch-fix` combines variety, personalization, reduced effort, and confidence.
- `citizenm-hotels` focuses on simplified travel, design, and access.
- `novo-nordisk-novopen` shows functional ease and reduced anxiety in a medical context.

## Common misuses

- Selecting too many elements and losing focus.
- Treating value elements as marketing claims without customer evidence.
