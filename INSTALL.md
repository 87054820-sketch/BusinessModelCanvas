...
技能包的作用是教会 AI 助手:PinGarden 有哪些战略画布、每张画布每块该怎么思考、如何拆解案例和设计实验。没有桌面 App 时,它就是战略学习/顾问模式；安装桌面 App 后,它还能通过 CLI 把内容写回应用。
...
如果你只安装了 skill 包,可以先在 AI 里问:

> 用 BMC 帮我分析 Spotify 的商业模式,并解释每个模块应该怎么理解

AI 应该会进入**战略学习/顾问模式**,直接解释框架、案例和填写建议。

如果你同时安装并打开了 PinGarden 桌面应用,可以再试:
