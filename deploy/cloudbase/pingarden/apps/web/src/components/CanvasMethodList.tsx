...
export function CanvasMethodList({ defs, lang, onStart }: Props) {
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {defs.map((def) => {
        ...
        return (
          <article
            key={def.id}
            className="group flex min-h-[252px] flex-col rounded-xl border border-gray-200 bg-white p-4 transition hover:border-emerald-200 hover:shadow-sm"
          >
            ...
            <div className="mt-4 flex flex-1 flex-col">
              ...
              <button
                ...
                className="mt-auto inline-flex w-fit items-center rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-800 transition hover:border-emerald-300 hover:bg-emerald-100 active:scale-[0.98]"
              >
