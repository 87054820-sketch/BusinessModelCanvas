...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // fork) and /library/patterns (list / get). Bare /library is the
      // SPA's "browse case library" page — proxying it would forward
      // direct URL hits to Fastify which 404s because there is no
      // GET /library handler. Keep these prefixes SPECIFIC to the API
